...
class ProposalsControllerTest < ActionController::TestCase
  ...
  test "should create proposal" do
    assert_difference('Proposal.count') do
      post :create, proposal: { description: @proposal.description, due_date: @proposal.due_date, title: @proposal.title }
    end
  ...
  test "should update proposal" do
    patch :update, id: @proposal, proposal: { description: @proposal.description, due_date: @proposal.due_date, title: @proposal.title }
    assert_redirected_to proposal_path(assigns(:proposal))
  end
